...
#define appconfINTERTILE_AUDIOPIPELINE_RCV_PORT 14
#define appconfINTERTILE_AUDIOPIPELINE_RCV_TASK_PRIORITY (configMAX_PRIORITIES-2)
...
#define appconfECHO_IP_ADDR_OCTET_2    	1
#define appconfECHO_IP_ADDR_OCTET_3    	6
